...
node tools/browser-tests/ascenso.mjs /tmp/capturas
```
...
| `ascenso.mjs` | Un vecino a un pelo del umbral pega un afiche y asciende: el cartel aparece, el chat lo canta y el cartel se retira solo. Es el camino que la auditoría encontró roto —la XP subía y el rango no se movía nunca— así que tiene prueba propia |
