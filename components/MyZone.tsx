...
export default function MyZone() {
  ...
  function EventRow({ e }: { e: AgendaEvent }) {
    return (
      <Link href={`/boards/${e.board_id}`} className="flex items-start gap-2.5 bg-[#1e293b] hover:bg-[#2e415c] rounded-lg px-3 py-2 transition-colors">
